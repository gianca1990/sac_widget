...
<form id="form">
    ...
    <td>
    <p>Api-Key:</p>
    <input id="builder_apiKey" type="text" placeholder="Dein Api-Key...">
    </td>
    </tr>
    <tr>
    <td>
    <p>Maximale Ergebnislänge (in Tokens):</p>
    <input id="builder_max_tokens" type="number" placeholder="Ergebnislänge...">
    </td>
    </tr>
